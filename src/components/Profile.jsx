...
import Navigation from "./Navigation"; // Your separate nav bar
import "./Profile.css";                // Scoped styling
...
export default function Profile() {
  ...
  const handleCoverUpload = async () => {
    ...
    try {
      ...
      await axios.patch("http://localhost:5000/api/user-profile/cover", formData, {
        headers: {
          Authorization: token,
  ...
  const saveAboutMe = async () => {
    try {
      ...
      await axios.put("http://localhost:5000/api/user-profile", updatedFields, {
        headers: { Authorization: token },
      });
      await fetchUser();
        ...
        <div className="info-container">
          ...
          <div className="profile-info-section">
            ...
            <div className="section-content">
              ...
              <p>Joined in: {user?.createdAt ? formatJoinedDate(user.createdAt) : "N/A"}</p>
          ...
          <div className="profile-info-section">
            ...
            <div className="section-content">
              {user?.citizenshipPhoto ? (
                <img
                  src={`http://localhost:5000/${user.citizenshipPhoto}`}
                  alt="Citizenship"
